  ...
  <body>
	...
	<div id="page">
	  ...
	  <div id="pageBody">
		...
		<form method="post" action="langword_add_check.php">
		  ...
		  <dt>翻訳言葉</dt>
		  <dd><input type="text" name="translate" style="width:500px" value=""></dd>
		  <dt>発音</dt>
		  <dd><input type="text" name="symbol" style="width:500px" value=""></dd>
		  <dt>音声データ</dt>
		  <dd><input type="text" name="sound" style="width:500px" value=""></dd>
