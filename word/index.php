	  ...
	  <div id="pageBody">
		  ...
		  <ul>
			...
			for($no=0; ${"situation".$no} != NULL; $no++){
			  print '<li><form method="post" name="word'.$no.'" action="wordlist.php">';
			  ...
			  print '<a href="javascript:document.word'.$no.'.submit()"><img src="img/situation/'.${"situation_img".$no}.'.png" alt="" width=300 height=250></a>';
			  print '</form></li>';
			}
